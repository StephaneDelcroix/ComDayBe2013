...
namespace MWC.DAL {
	...
	public static class DataManager {
		...
		public static IEnumerable<UserGroup> GetUserGroups ()
		{
			return DL.MwcDatabase.GetItems<UserGroup> ().OrderBy (ug => ug.Name);
		}

		public static UserGroup GetUserGroup (int id)
		{
			return DL.MwcDatabase.GetUserGroup (id);
		}

		public static UserGroup GetUserGroupWithName (string name)
		{
			return DL.MwcDatabase.GetUserGroupWithName (name);
		}

		public static void SaveUserGroups (IEnumerable<UserGroup> items)
		{
			DL.MwcDatabase.SaveItems<UserGroup> (items);
		}

		public static int DeleteUserGroup (int id)
		{
			return DL.MwcDatabase.DeleteItem<UserGroup> (id);
		}

		public static void DeleteUserGroups ()
		{
			DL.MwcDatabase.ClearTable<UserGroup> ();
		}
		#endregion
